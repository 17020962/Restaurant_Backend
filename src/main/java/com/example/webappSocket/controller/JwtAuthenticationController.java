...
import com.example.webappSocket.config.JwtTokenUtil;
import com.example.webappSocket.model.JwtRequest;
import com.example.webappSocket.model.JwtResponse;
import com.example.webappSocket.service.JwtUserDetailsService;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        ...
        System.out.print("This is author: " + userDetails.getAuthorities().toString());
